...
void calculate_r_or_du(mpz_t &rs_out, mpz_t e, mpz_t k, mpz_t r_or_d_ca) {
    ...
    mpz_init(rs_out);
    ffe_t f_e(e, Ed_curves25519->orderG), f_k(k, Ed_curves25519->orderG), f_r_or_dca(r_or_d_ca, Ed_curves25519->orderG),rs;
